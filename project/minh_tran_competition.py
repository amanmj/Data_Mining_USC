...
if __name__ == "__main__":
    ...
    predictions2 = valData.map(lambda x: predictRatingUserBased(x[0][0],x[0][1],userBusinessRatingDict,userBusinessDict,avgBusinessRating,sumUserRating,businessUserDict, avgUserRating))
    # print("predictions: ", predictions.collect())
    #
    validation2 = predictions2.join(valData)
